...
/*GetInfoOK global server information
...
func (o *GetInfoOK) WithPayload(payload []*models.Server) *GetInfoOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get info o k response
func (o *GetInfoOK) SetPayload(payload []*models.Server) {
	o.Payload = payload
}
...
func (o *GetInfoOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = make([]*models.Server, 0, 50)
	}
